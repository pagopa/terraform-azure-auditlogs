...
| <a name="input_log_analytics_workspace_rg_name"></a> [log\_analytics\_workspace\_rg\_name](#input\_log\_analytics\_workspace\_rg\_name) | The name of the resource group of log analytics workspace | `string` | n/a | yes |
